...
def main():
    ...
    # ISONET.prepare_star(None,'E:\\workspace\\py_workspace\\py_fold\\IsoNet-master\\data_isonet\\neuron')
    # ISONET.prepare_star(None,'/public/home/yuyibei2023/IsoNet-unet-noise-modify_loss12_absplus_hiv/data_isonet/HIV/demo_data/tomograms') #生成tomograms.star
    # ISONET.deconv(None,star_file='/public/home/yuyibei2023/IsoNet-unet-noise-modify_loss12_absplus_hiv/IsoNet/bin/tomograms.star',snrfalloff=0.7,deconvstrength=1) # 生成deconv文件夹
    # ISONET.make_mask(None,star_file='/public/home/yuyibei2023/IsoNet-unet-noise-modify_loss12_absplus_hiv/IsoNet/bin/tomograms.star') # 生成 mask文件夹
    # ISONET.extract(None,star_file='/public/home/yuyibei2023/IsoNet-unet-noise-modify_loss12_absplus_hiv/IsoNet/bin/tomograms.star',crop_size=96) # 生成sybtomo文件夹
